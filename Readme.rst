...
Finally, you can run an automatic installer using the following code::
    ...
    $ curl https://raw.githubusercontent.com/DesertPunk/nanorc/Test-branch/install.sh | sh

or alternatively::

    $ wget https://raw.githubusercontent.com/DesertPunk/nanorc/Test-branch/install.sh -O- | sh
